% EDITED 2014-10-6: fixed group mix-up! (movie and model groups were
% misidentified.)
...
strNameAnalysis	= '20140514_allci_namecorrected_copy';
...
for kMask = 1:nMaskOrig
    strMask = cMaskOrig{kMask};
